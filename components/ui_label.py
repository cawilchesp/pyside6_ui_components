...
class UI_Label(QLabel):
    ...
    def __init__(
        ...
        self.setStyleSheet(f"UI_Label[value=true] {{ border-color: {border_color} }}") if type == 'value' else None
    ...
    def set_color_label(self, color: str) -> None:
        ...
        self.setStyleSheet(f"UI_Label[color=true] {{ background-color: {color} }}")
